...
IS_2013 <- read.csv("../OriginalData/IsraelSpainPops2013 GH.csv", na.strings=".")
...
write.csv(JustSSR, "../output/JustSSR.csv", row.names = F, quote=F)
system("python biallele.py ../output/JustSSR.csv ../output/BiSSR.csv")

JustSSRFix <- read.csv("../output/BiSSR.csv", header = T)
...
```{r write, echo=FALSE}
write.csv(CombinedDataSet, "../output/CombinedDataSet.csv", quote=F, row.names=F)
write.csv(BialleleGene, "../output/AllBialleleGeno.csv", row.names = F)
write.csv(BialleleGene[c(2:nrow(BialleleGene)), c(2:ncol(BialleleGene))], "../output/Marker.geno", row.names = F)
write.csv(BialleleGene, "../output/Marker.ind", row.names = F)
