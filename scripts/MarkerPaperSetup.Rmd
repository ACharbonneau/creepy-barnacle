...
hist(as.numeric(SurviveGTF), breaks=SGTF$breaks, main = "SurviveGTF vs. GTF", col = rgb(1,0,0, alpha = .3), xlab="DTF")
hist(as.numeric(GTF), breaks=SGTF$breaks, add=T, col = rgb(0,0,1, alpha = .3))
...
```{r, echo=FALSE}
#germination latency
plot(PTG, pch=16, col=col_pal3[Experiment], main = "Planting to Germination")
legend(550, 150, legend = levels(Experiment), ncol = 3, bty = "n", col=col_pal3[], pch = 16)
