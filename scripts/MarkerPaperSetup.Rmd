...
JustSSR <- Genotypes[c(22:25)]
write.csv(JustSSR, "../output/JustSSR.csv")
system("python biallele.py ../output/JustSSR.csv ../output/BiSSR.csv")
read.csv("../output/BiSSR.csv", header = T)


#JustSSR <- as.data.frame(cbind(paste(Genotypes$SSR.ID, Genotypes$Pop, sep = ""),  
#                               Genotypes[, c(20:length(colnames(Genotypes)))])
#colnames(JustSSR) <- c("Name", colnames(JustSSR[2:17]))
