...
write.csv(BialleleGene[c(2:nrow(BialleleGene)), c(2:ncol(BialleleGene))], "../MungedData/Marker.geno", row.names = F)
write.csv(BialleleGene, "../MungedData/Marker.ind", row.names = F)
