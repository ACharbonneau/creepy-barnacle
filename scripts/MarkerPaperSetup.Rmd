...
```{r Assign1, echo=TRUE}
SubSpeciesList <- c(ADOL="sativus", AROL="sativus", CBBG="sativus", COOL="sativus", DAJO="sativus", ESNK="sativus", MABG="sativus", MYJO="sativus", NELO="sativus", OIBG="sativus", RABG="sativus", RACA="sativus", SPEU="sativus", TOBG="sativus", WMBG="sativus", AFFR="raphanistrum", BBCA="CAHybrid", BINY="raphanistrum", GSCA="CAHybrid", MAES="raphanistrum", PBFR="maritimus", SAES="maritimus", DEES="raphanistrum", GHIL="raphanistrum", HCES="raphanistrum", HMES="raphanistrum", HZIL="raphanistrum", IMES="raphanistrum", ZYIL="raphanistrum", AUFI="raphanistrum", COAU="raphanistrum", KAMI="raphanistrum", AL="raphanistrum", CBES="maritimus", GMIL="rostratus", M3AU="raphanistrum", N3="raphanistrum",  NZIL="confusus", PG6="raphanistrum", REIL="raphanistrum", MAFI="raphanistrum", NAAU="raphanistrum", WEAU="raphanistrum", CGBC="sativus", FGBC="sativus", FRSI="sativus", LBBC="sativus", MBBC="sativus", NTJO="sativus", PABS="sativus", RABS="sativus", RBBC="sativus", SPNK="sativus", TYIL="raphanistrum")
```
...
LocationList <- c(ADOL="oleifera", AROL="oleifera", CBBG="european", COOL="oleifera", DAJO="european", ESNK="european", MABG="caudatus", MYJO="daikon", NELO="daikon", OIBG="oleifera", RABG="caudatus", RACA="caudatus", SPEU="european", TOBG="daikon", WMBG="daikon", AFFR="raphNatW", BBCA="California", BINY="raphNN", GSCA="California", MAES="raphNatW", PBFR="lanmar", SAES="lanmar", DEES="raphNatW", GHIL="raphNatE", HCES="raphNatW", HMES="raphNatW", HZIL="raphNatE", IMES="raphNatW", ZYIL="raphNatE", AUFI="raphNN", COAU="raphNN", KAMI="raphNN", AL="raphNN", CBES="lanmar", GMIL="rostratus", M3AU="raphNN", N3="raphNN", NZIL="none", PG6="raphNN", REIL="raphNatE", MAFI="raphNN", NAAU="raphNN", WEAU="raphNN", CGBC="daikon", FGBC="daikon", FRSI="european", LBBC="european", MBBC="european", NTJO="european", PABS="european", RABS="european", RBBC="european", SPNK="european", TYIL="raphNatE")

OrderList <- c(ADOL=19, AROL=20, CBBG=7, COOL=21, DAJO=8, ESNK=9, MABG=22, MYJO=3, NELO=4,
               OIBG=23, RABG=24, RACA=25, SPEU=17, TOBG=5, WMBG=6, AFFR=4, BBCA=30, BINY=3,
               GSCA=30, MAES=9, PBFR=1, SAES=3, DEES=5, GHIL=10, HCES=6, HMES=7, HZIL=11,
               IMES=8, ZYIL=14, AUFI=1, COAU=4, KAMI=8, AL=7, CBES=2, GMIL=15, M3AU=7,
               N3=7, NZIL=16, PG6=7, REIL=12, MAFI=2, NAAU=6, WEAU=5, CGBC=1,
