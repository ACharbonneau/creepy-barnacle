...
ExtraRawData <- select( FlowData, ID, GTF, Geography, Seedstock, 
                   GrowthEnvironment, DOYGS, DaysVernNoNA, 
                   Pop, Experiment, Habitat, PTF, DOYPS, PTG, 
...
Nat_pop_chains <- Nat_glmm$Sol[ , 13:27 ] + Nat_glmm$Sol[ , 1 ]
...
Nat_NoV_pop_chains <- Nat_glmm_noV$Sol[ , 12:26 ] + Nat_glmm_noV$Sol[ , 1 ]
...
```{r PlotNatPopMeans, echo=FALSE, fig.path="../Figures/", fig.keep="last", fig.width=11, eval=T}
plot.new()
