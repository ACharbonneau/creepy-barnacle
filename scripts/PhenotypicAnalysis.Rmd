...
Nat_overplot$SubSp
levels(Nat_overplot$SubSp)[levels(Nat_overplot$SubSp)=="rostratus"] <- ""
...
mtext(text = expression(italic("R.pugioniformis")), side = 3, line = -.95, at=.92, cex = .8)
```
...
axis(side = 1, at=c(seq(from=.9, to=18.9, by=.9)), tick = F, line=-1.5, ylim=c(0, 300),
     label=c("CGBC","FGBC","MYJO","NEJS","TOBG","WMBG","CBBG","DAJO","ESNK","FRSI",
             "LBBC","RABS","RBBC","SPNK","ADOL","AROL","COOL","OIBG","MABG","RABG","RAJS"))
par(cex=1)
