...
MarkerPop <- read.csv("../OriginalData/MarkerPopOrder.csv", header = F)
...
# Dropping one plant. It was the only CBES to germinate in that year/experiment, and it was really sick/weird. Since it's the only CBES plant in that experiment, it's also ruining all my calculations that rely on experiment level SD
CombinedDataSet <- CombinedDataSet %>% mutate( arb_num= 1:nrow( CombinedDataSet ) )


bob <- CombinedDataSet[ CombinedDataSet$Experiment =="field2013" & CombinedDataSet$ID ==613 ,]

CombinedDataSet <- CombinedDataSet[ CombinedDataSet$arb_num != bob$arb_num ,]
...
write.table(t(BialleleGene[, c(3:ncol(BialleleGene))]), "../MungedData/Marker.geno", row.names = F, col.names = F, sep="", na = "9")
...
write.table(cbind( colnames(BialleleGene)[ 3:123 ], 
       c(rep(1,3), rep(2,3), rep(6,3), 8, 4, 9, 9, 
         rep(5,40), rep(7,16), rep(10,7), rep(1, 22), 
         rep(3,9), rep(6,14)), rep(0, 121), rep(0, 121)),
...
STR_labeled <- STR_geno

STR_sum <- left_join(STR_labeled, MarkerPop, by=c("SSR.ID"="V1"))

STR_sum <- select(STR_sum, SSR.ID, Pop, V11, DWRD_124, DWRD_124_2, DWRD_112, 
                  DWRD_112_2, DWRD_61, DWRD_61_2, DWRD_177, DWRD_177_2, DWRD_107, 
                  DWRD_107_2, DWRD_123, DWRD_123_2, DWRD_121, DWRD_121_2, DWRD_158, 
                  DWRD_158_2, DWRD_48, DWRD_48_2, DWRD_180, DWRD_180_2, DWRD_97, 
                  DWRD_97_2, DWRD_205, DWRD_205_2, DWRD_27, DWRD_27_2, Bn26a, 
                  Bn26a_2, BRMS005, BRMS005_2, Na10H06, Na10H06_2, Ra1H08, 
                  Ra1H08_2, Ra2E11, Ra2E11_2, Na14E08, Na14E08_2, Bn35d, Bn35d_2, 
                  Na12E05, Na12E05_2)
...
for (i in 1:20) {
  ...
  write.table(matrix(STR_columns, nrow=1), c(paste( "../MungedData/", i, "rand.str", coll='', sep='')), 
              quote = FALSE, sep = " ", row.names = FALSE, eol = "\n", col.names = FALSE)
  write.table( STR_geno_shuffle, paste( "../MungedData/", i, "rand.str", coll='', sep=''), 
               quote = FALSE, sep = " ", row.names = FALSE, col.names = FALSE, append = TRUE, na = "-9")
}

#Need to write out a version with character metadata for summary stats. It's just easier.
write.table(matrix(STR_columns, nrow=1), "../MungedData/1randSS.str", 
              quote = FALSE, sep =" ", row.names = FALSE, eol = "\n", col.names = FALSE)
write.table( STR_sum, paste( "../MungedData/1randSS.str", coll='', sep=''), 
               quote = FALSE, sep = " ", row.names = FALSE, col.names = FALSE, append = TRUE, na = "-9")
