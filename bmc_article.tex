...
\section*{Methods}
% * <willpitchers@gmail.com> 2015-11-08T23:51:42.612Z:
%
% > Methods
%
% in answer to your query, I don't think that the methods are overly long -- I'd suggest that it'd be more honest to include a section explicitly explaining how the dataset was human-centipede-ed  together from piles of dross, but I know that JC won't have it...
%
% ^.
...
% * <willpitchers@gmail.com> 2015-11-08T23:34:41.896Z:
%
% > 2008
%
% cite?
...
% * <willpitchers@gmail.com> 2015-11-08T23:37:22.279Z:
%
% > 70 total populations
%
% 70 pops or 69?
%
% ^.
...
% * <willpitchers@gmail.com> 2015-11-08T23:38:25.719Z:
%
% > a dude from KBS
%
% PLS CAN HAZ FIX?
...
% * <willpitchers@gmail.com> 2015-11-08T23:43:17.878Z:
%
% > 2008
%
% citekey?
%
% ^.
% * <willpitchers@gmail.com> 2015-11-08T23:42:50.284Z:
%
% > NsiI, PstI, HindIII, EcoRI, BclII, EvoRV, KPNI, and NDEI
%
% Do plant genes get italicised?
%
% ^.
% * <willpitchers@gmail.com> 2015-11-08T23:42:14.613Z:
%
% > custom Python script
%
% Tack? has he made it available?
%
% ^.
...
% * <willpitchers@gmail.com> 2015-11-08T23:45:35.056Z:
%
% > different randomization of the data input order.
%
% I think that here would be a good place for a quick parenthetical explanation of why you needed to do that.
%
% ^.
...
% * <willpitchers@gmail.com> 2015-11-08T23:49:47.460Z:
%
% > lme4 package
%
% I thought you'd gone MCMCglmm on this?
%
% ^.
...
\section*{Discussion}
% * <willpitchers@gmail.com> 2015-11-08T23:31:52.848Z:
%
% > Discussion
%
% In answer to one of your queries, I do think that you've done a good job getting the introduction to 'match up' with the discussion -- they read like parts of the same story to me.
%
% ^.
...
% * <willpitchers@gmail.com> 2015-11-08T22:59:09.594Z:
%
% > citation
%
% JC? ID?
...
% * <willpitchers@gmail.com> 2015-11-08T23:20:01.258Z:
%
% > For instance, both \textit{R.r. landra} and \textit{R.r. maritimus} are very similar in terms of rosette morphology, are adapted for water-borne seed dispersal {Warwick:2005fm} and are found in the same habitats: primarily in coastal dunes, which would suggest that any flowering time differences should be due to drift. However, \textit{R.r. landra} and \textit{R.r. maritimus} cluster genetically at neutral markers [Figures: SmartPCA and STRUCTURE579] as well as geographically, and in the taxonomic literature {Warwick:2005fm}, which suggests that any phenotypic differences should be due to selection, and that perhaps these are true sub-species.
%
% this sentence might be easier on the reader if you split it in two...
%
% ^.
% * <willpitchers@gmail.com> 2015-11-08T23:19:08.003Z:
%
% > STRUCTURE579
%
% 579?
...
% * <willpitchers@gmail.com> 2015-11-08T23:30:24.920Z:
%
% > it appears
%
% "our data is consistent with"? or "our findings suggest that"?
%
% ^.
